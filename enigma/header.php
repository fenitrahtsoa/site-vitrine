			...
			<div class="row ">
				<div class="col-md-6 col-sm-12 wl_rtl" >					
					...
					<?php if($wl_theme_options['upload_image_logo']){ ?>
						<img class="img-responsive logo_bas" src="<?php echo $wl_theme_options['upload_image_logo']; ?>" style="height:<?php if($wl_theme_options['height']!='') { echo $wl_theme_options['height']; }  else { "80"; } ?>px; width:<?php if($wl_theme_options['width']!='') { echo $wl_theme_options['width']; }  else { "200"; } ?>px;" />
						<?php } else {
